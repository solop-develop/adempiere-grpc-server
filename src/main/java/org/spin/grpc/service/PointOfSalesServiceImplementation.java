...
import org.spin.backend.grpc.AddressRequest;
import org.spin.backend.grpc.AllocateSellerRequest;
import org.spin.backend.grpc.AvailableCash;
import org.spin.backend.grpc.AvailableDocumentType;
import org.spin.backend.grpc.AvailablePaymentMethod;
import org.spin.backend.grpc.AvailablePriceList;
import org.spin.backend.grpc.AvailableRefund;
import org.spin.backend.grpc.AvailableWarehouse;
import org.spin.backend.grpc.CashClosing;
import org.spin.backend.grpc.CashClosingRequest;
import org.spin.backend.grpc.CashOpeningRequest;
import org.spin.backend.grpc.CashWithdrawalRequest;
import org.spin.backend.grpc.CreateCustomerBankAccountRequest;
import org.spin.backend.grpc.CreateCustomerRequest;
import org.spin.backend.grpc.CreateOrderLineRequest;
import org.spin.backend.grpc.CreateOrderRequest;
import org.spin.backend.grpc.CreatePaymentReferenceRequest;
import org.spin.backend.grpc.CreatePaymentRequest;
import org.spin.backend.grpc.CreateShipmentLineRequest;
import org.spin.backend.grpc.CreateShipmentRequest;
import org.spin.backend.grpc.Customer;
import org.spin.backend.grpc.CustomerBankAccount;
import org.spin.backend.grpc.DeallocateSellerRequest;
import org.spin.backend.grpc.DeleteCustomerBankAccountRequest;
import org.spin.backend.grpc.DeleteOrderLineRequest;
import org.spin.backend.grpc.DeleteOrderRequest;
import org.spin.backend.grpc.DeletePaymentReferenceRequest;
import org.spin.backend.grpc.DeletePaymentRequest;
import org.spin.backend.grpc.DeleteShipmentLineRequest;
import org.spin.backend.grpc.Empty;
import org.spin.backend.grpc.GetAvailableRefundRequest;
import org.spin.backend.grpc.GetCustomerBankAccountRequest;
import org.spin.backend.grpc.GetCustomerRequest;
import org.spin.backend.grpc.GetKeyLayoutRequest;
import org.spin.backend.grpc.GetOrderRequest;
import org.spin.backend.grpc.GetProductPriceRequest;
import org.spin.backend.grpc.HoldOrderRequest;
import org.spin.backend.grpc.KeyLayout;
import org.spin.backend.grpc.KeyValue;
import org.spin.backend.grpc.ListAvailableCashRequest;
import org.spin.backend.grpc.ListAvailableCashResponse;
import org.spin.backend.grpc.ListAvailableCurrenciesRequest;
import org.spin.backend.grpc.ListAvailableCurrenciesResponse;
import org.spin.backend.grpc.ListAvailableDocumentTypesRequest;
import org.spin.backend.grpc.ListAvailableDocumentTypesResponse;
import org.spin.backend.grpc.ListAvailablePaymentMethodsRequest;
import org.spin.backend.grpc.ListAvailablePaymentMethodsResponse;
import org.spin.backend.grpc.ListAvailablePriceListRequest;
import org.spin.backend.grpc.ListAvailablePriceListResponse;
import org.spin.backend.grpc.ListAvailableSellersRequest;
import org.spin.backend.grpc.ListAvailableSellersResponse;
import org.spin.backend.grpc.ListAvailableWarehousesRequest;
import org.spin.backend.grpc.ListAvailableWarehousesResponse;
import org.spin.backend.grpc.ListCashMovementsRequest;
import org.spin.backend.grpc.ListCashMovementsResponse;
import org.spin.backend.grpc.ListCashSummaryMovementsRequest;
import org.spin.backend.grpc.ListCashSummaryMovementsResponse;
import org.spin.backend.grpc.ListCustomerBankAccountsRequest;
import org.spin.backend.grpc.ListCustomerBankAccountsResponse;
import org.spin.backend.grpc.ListOrderLinesRequest;
import org.spin.backend.grpc.ListOrderLinesResponse;
import org.spin.backend.grpc.ListOrdersRequest;
import org.spin.backend.grpc.ListOrdersResponse;
import org.spin.backend.grpc.ListPaymentReferencesRequest;
import org.spin.backend.grpc.ListPaymentReferencesResponse;
import org.spin.backend.grpc.ListPaymentsRequest;
import org.spin.backend.grpc.ListPaymentsResponse;
import org.spin.backend.grpc.ListPointOfSalesRequest;
import org.spin.backend.grpc.ListPointOfSalesResponse;
import org.spin.backend.grpc.ListProductPriceRequest;
import org.spin.backend.grpc.ListProductPriceResponse;
import org.spin.backend.grpc.ListShipmentLinesRequest;
import org.spin.backend.grpc.ListShipmentLinesResponse;
import org.spin.backend.grpc.ListStocksRequest;
import org.spin.backend.grpc.ListStocksResponse;
...
import org.spin.backend.grpc.PaymentReference;
import org.spin.backend.grpc.PaymentSummary;
import org.spin.backend.grpc.PointOfSales;
import org.spin.backend.grpc.PointOfSalesRequest;
import org.spin.backend.grpc.PrintPreviewRequest;
import org.spin.backend.grpc.PrintPreviewResponse;
import org.spin.backend.grpc.PrintTicketRequest;
import org.spin.backend.grpc.PrintTicketResponse;
import org.spin.backend.grpc.ProcessLog;
import org.spin.backend.grpc.ProcessOrderRequest;
import org.spin.backend.grpc.ProcessShipmentRequest;
import org.spin.backend.grpc.ProductPrice;
import org.spin.backend.grpc.ReleaseOrderRequest;
import org.spin.backend.grpc.ReverseSalesRequest;
...
import org.spin.backend.grpc.Stock;
import org.spin.backend.grpc.StoreGrpc.StoreImplBase;
import org.spin.backend.grpc.UpdateCustomerBankAccountRequest;
import org.spin.backend.grpc.UpdateCustomerRequest;
import org.spin.backend.grpc.UpdateOrderLineRequest;
import org.spin.backend.grpc.UpdateOrderRequest;
import org.spin.backend.grpc.UpdatePaymentRequest;
import org.spin.backend.grpc.ValidatePINRequest;
