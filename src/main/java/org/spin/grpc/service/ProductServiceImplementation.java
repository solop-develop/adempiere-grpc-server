...
import org.spin.backend.grpc.ListProductInfoRequest;
import org.spin.backend.grpc.ProductGrpc.ProductImplBase;
 ...
 */
public class ProductServiceImplementation extends ProductImplBase {
	/**	Logger			*/
	private CLogger log = CLogger.getCLogger(ProductServiceImplementation.class);
	 ...
	 * @return
	 */
	private ListEntitiesResponse.Builder convertEntitiesListFronGeneralInfo(Properties context, ListProductInfoRequest request) {		
