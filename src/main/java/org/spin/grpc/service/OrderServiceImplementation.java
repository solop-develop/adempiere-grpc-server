...
import org.spin.backend.grpc.ListOrderInfoRequest;
import org.spin.backend.grpc.OrderGrpc.OrderImplBase;
 ...
 */
public class OrderServiceImplementation extends OrderImplBase {
	/**	Logger			*/
	private CLogger log = CLogger.getCLogger(OrderServiceImplementation.class);
