...
import org.spin.backend.grpc.InvoiceGrpc.InvoiceImplBase;
import org.spin.backend.grpc.ListEntitiesResponse;
import org.spin.backend.grpc.ListInvoiceInfoRequest;
 ...
 */
public class InvoiceServiceImplementation extends InvoiceImplBase {
	/**	Logger			*/
	private CLogger log = CLogger.getCLogger(InvoiceServiceImplementation.class);
	 ...
	 * @return
	 */
	private ListEntitiesResponse.Builder convertEntitiesListFronGeneralInfo(Properties context, ListInvoiceInfoRequest request) {		
