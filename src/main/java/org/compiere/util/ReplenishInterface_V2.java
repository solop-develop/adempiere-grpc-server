 ...
 */
public interface ReplenishInterface_V2 extends ReplenishInterface
{
	 ...
	 *	@return qty to order
	 */
	public BigDecimal getQtyToOrder (MWarehouse wh, X_T_Replenish replenish, SvrProcess processInstance);
	
}	//	ReplenishmentInterface_V2
