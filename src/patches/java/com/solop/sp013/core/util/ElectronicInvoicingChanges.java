...
public interface ElectronicInvoicingChanges {
	...
	/**	Async validation: the document is sent and then its state is consulted (e.g. SUNAT GRE)	*/
	String SP013_IsAsyncValidation = "SP013_IsAsyncValidation";
	...
	/**	Invoice Document Type	*/
	String SP013_MInvoiceDocType_ID = "SP013_MInvoiceDocType_ID";
	/**	Debit Memo Document Type	*/
	String SP013_MDebitDocType_ID = "SP013_MDebitDocType_ID";
	/**	Credit Memo Document Type	*/
	String SP013_MCreditDocType_ID = "SP013_MCreditDocType_ID";
	/**	Fiscal Document No	*/
	...
	String SP013_InvoiceDocumentNote = "SP013_InvoiceDocumentNote";
	/** Product Code Types */
	String ProductCode_Internal = "INT1";
	String ProductCode_EAN = "EAN";

	/** Tax Values*/
	String Tax_Exempt = "1";
	String Tax_Minimum = "2";
	String Tax_Basic = "3";
	String Tax_AnotherRate = "4";
	String Tax_free = "5";
	String Tax_ProductNotInvoiceable = "6";
	String Tax_Export = "10";
}
