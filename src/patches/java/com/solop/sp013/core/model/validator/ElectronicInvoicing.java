	...
	public String docValidate(PO po, int timing) {
		...
		if(timing == TIMING_BEFORE_REVERSECORRECT
			...
			if(po.get_TableName().equals(I_C_Invoice.Table_Name)) {
				...
				//	When a sent electronic comprobante is voided, ask the provider to cancel it at SUNAT
				//	(comunicación de baja). Providers that cancel only via credit notes do not implement
