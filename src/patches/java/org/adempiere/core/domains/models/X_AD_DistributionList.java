...
/** Generated Model for AD_DistributionList
 *  @author Adempiere (generated) 
 *  @version Release 3.9.4 - $Id$ */
public class X_AD_DistributionList extends PO implements I_AD_DistributionList, I_Persistent 
{
    ...
    public X_AD_DistributionList (Properties ctx, int AD_DistributionList_ID, String trxName)
    {
      super (ctx, AD_DistributionList_ID, trxName);
      /** if (AD_DistributionList_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_AD_DistributionList (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_AD_DistributionList[")
