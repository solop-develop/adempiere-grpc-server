...
public class E_InvoiceDocument_v2 implements ICFEDocument_v2 {
    ...
    protected CFEInvoiCyType.Totales convertTotals() {
        ...
        System.out.println("TotTpoMoneda" + totals.getTotTpoMoneda() );
        System.out.println("TotTpoCambio" + totals.getTotTpoCambio() );
        ...
        System.out.println("monto total" + totals.getTotMntTotal() );
