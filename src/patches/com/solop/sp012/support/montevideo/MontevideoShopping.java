package com.solop.sp012.support.montevideo;
...
import com.solop.sp012.support.montevideo.dto.declaVtas.Entrada;
import com.solop.sp012.support.montevideo.dto.declaVtas.Salida;
import com.solop.sp012.support.montevideo.dto.declaVtas.WsDeclaVtasPortType;
import com.solop.sp012.support.montevideo.dto.declaVtas.WsDeclaVtasService;
import com.solop.sp012.support.montevideo.dto.wsConsxCont.WsConsxContPortType;
import com.solop.sp012.support.montevideo.dto.wsConsxCont.WsConsxContService;
import com.solop.sp012.support.montevideo.dto.wsConsxRUT.WsConsxRUTPortType;
import com.solop.sp012.support.montevideo.dto.wsConsxRUT.WsConsxRUTService;
...
public class MontevideoShopping implements IShopping, IShoppingQueryContracts, IShoppingQuerySector {

    /**	Registration Id	*/
    private int registrationId = 0;
    private static final CLogger logger = CLogger.getCLogger(MontevideoShopping.class);
    ...
    public IShoppingResponse sendDocument(IShoppingDocument document) {
        ...
        Entrada.WsDeclaVtas wsDeclaVtas2 = new Entrada.WsDeclaVtas();
        entrada.getWsDeclaVtas().add(wsDeclaVtas2);
        Entrada.WsDeclaVtas.General general = new Entrada.WsDeclaVtas.General();
        wsDeclaVtas2.setGeneral(general);
        Entrada.WsDeclaVtas.General.Cab header = new Entrada.WsDeclaVtas.General.Cab();
        general.setCab(header);
        List<Entrada.WsDeclaVtas.General.Det> details = wsDeclaVtas2.getGeneral().getDet();
        ...
        header.setTipodeCambio(1);// TODO cambiar a un valor dinámico
        ...
        header.setTipodeCambio(rate.get().doubleValue());
        ...
        mapLines.forEach((materialGroupId, mInvoiceLines) -> {
            ...
            double totalAmt =  mInvoiceLines.stream().mapToDouble(value -> value.getLineTotalAmt().doubleValue()).sum();
            if (invoice.isTaxIncluded()) {
                double taxAmt = mInvoiceLines.stream().mapToDouble(value -> value.getTaxAmt().doubleValue()).sum();
                totalAmt -= taxAmt;
            }
            Entrada.WsDeclaVtas.General.Det detail = new Entrada.WsDeclaVtas.General.Det();
            details.add(detail);
        ...
        try {
            ...
            WsDeclaVtasService service = new WsDeclaVtasService(new URL(host + "/soap/portal/services/forms/v1.3/wsDeclaVtas?wsdl"));
            WsDeclaVtasPortType port = service.getWsDeclaVtasPort();
    ...
    public ShoppingContractList getContracts(String taxId) {
        com.solop.sp012.support.montevideo.dto.wsConsxRUT.Entrada.WsConsxRUT request = new com.solop.sp012.support.montevideo.dto.wsConsxRUT.Entrada.WsConsxRUT();

        com.solop.sp012.support.montevideo.dto.wsConsxRUT.Entrada.WsConsxRUT.General general = new com.solop.sp012.support.montevideo.dto.wsConsxRUT.Entrada.WsConsxRUT.General();
        request.setGeneral(general);
        com.solop.sp012.support.montevideo.dto.wsConsxRUT.Entrada.WsConsxRUT.General.Cab cab = new com.solop.sp012.support.montevideo.dto.wsConsxRUT.Entrada.WsConsxRUT.General.Cab();
        general.setCab(cab);
        ...
        try {
            service = new WsConsxRUTService(new URL(host + "/soap/portal/services/sim/v1.3/wsConsxRUT?wsdl"));
        ...
        try {
            List<com.solop.sp012.support.montevideo.dto.wsConsxRUT.Salida.RWsConsxRUT> response = port.simular(List.of(request));
    ...
    public ShoppingSectorList getSectors(String taxId, String shoppingCode, int contractNumber) {
        com.solop.sp012.support.montevideo.dto.wsConsxCont.Entrada.WsConsxCont request = new com.solop.sp012.support.montevideo.dto.wsConsxCont.Entrada.WsConsxCont();

        com.solop.sp012.support.montevideo.dto.wsConsxCont.Entrada.WsConsxCont.General general = new com.solop.sp012.support.montevideo.dto.wsConsxCont.Entrada.WsConsxCont.General();
        request.setGeneral(general);
        com.solop.sp012.support.montevideo.dto.wsConsxCont.Entrada.WsConsxCont.General.Cab cab = new com.solop.sp012.support.montevideo.dto.wsConsxCont.Entrada.WsConsxCont.General.Cab();
        general.setCab(cab);
        cab.setNumeroRUT(taxId);
        ...
        try {
            service = new WsConsxContService(new URL(host + "/soap/portal/services/sim/v1.3/wsConsxCont?wsdl"));
        } catch (MalformedURLException e) {
            throw new AdempiereException(e);
        }
        ...
        try {
            List<com.solop.sp012.support.montevideo.dto.wsConsxCont.Salida.RWsConsxCont> response = port.simular(List.of(request));
