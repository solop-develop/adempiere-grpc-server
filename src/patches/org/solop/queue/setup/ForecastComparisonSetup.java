 ...
 */
public class ForecastComparisonSetup implements ISetupDefinition {
	...
	public String doIt(Properties context, String transactionName) {
		...
		createForecastSchedule(context, transactionName);
	 ...
	 */
	private void createForecastSchedule(Properties context, String transactionName) {

		MScheduler scheduler = new MScheduler(context, 0, transactionName);
		scheduler.setAD_Org_ID(0);
		scheduler.setName("Forecast Comparison Queue");
		scheduler.setDescription("Forecast Comparison Queue");
