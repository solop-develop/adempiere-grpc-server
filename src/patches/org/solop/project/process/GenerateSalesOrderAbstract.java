 ...
 */
public abstract class GenerateSalesOrderAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "C_ProjectLine_Generate";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Generate Sales Order (From Line)";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54781;
