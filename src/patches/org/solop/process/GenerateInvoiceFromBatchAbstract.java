 ...
 */
public abstract class GenerateInvoiceFromBatchAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SP030C_PR_GenerateInvoices";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Generate Invoices";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 1010410;
