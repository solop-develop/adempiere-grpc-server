...
/** Generated Process for (Create Consignment Sales Invoice)
 *  @author ADempiere (generated) 
 *  @version Release 3.9.4
 */
public abstract class CreateARInvoiceFromSalesDropShipmentAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "CreateConsignmentSalesInvoice";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Create Consignment Sales Invoice";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54895;
