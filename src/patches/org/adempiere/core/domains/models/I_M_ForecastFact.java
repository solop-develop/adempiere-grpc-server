...
public interface I_M_ForecastFact 
{
    ...
    public static final String Table_Name = "M_ForecastFact";
    ...
    /** Column name M_ForecastFact_ID */
    public static final String COLUMNNAME_M_ForecastFact_ID = "M_ForecastFact_ID";
