...
// -
	...
	/** Set Parent Project.
		@param ParentProject_ID 
		The parent (summary) project
	  */
	public void setParentProject_ID (int ParentProject_ID)
	{
		if (ParentProject_ID < 1) 
			set_Value (COLUMNNAME_ParentProject_ID, null);
		else 
			set_Value (COLUMNNAME_ParentProject_ID, Integer.valueOf(ParentProject_ID));
	}

	/** Get Parent Project.
		@return The parent (summary) project
	  */
	public int getParentProject_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ParentProject_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** ProjectBased AD_Reference_ID=54136 */
	public static final int PROJECTBASED_AD_Reference_ID=54136;
	/** Lines = L */
